...
```{r}
cluster_url = "https://raw.githubusercontent.com/puzeng/BIOSTAT707_Course_Project/main/Hierarchical_Clustering/hc_cluster.csv"
cluster_df = read_csv(cluster_url)
...
cluster_df = cluster_df %>% select(id, date2, cluster)
```
...
covid_weekly_1 = covid_weekly_1 %>% left_join(cluster_df, by = c("id", "date2"))
covid_weekly_2 = covid_weekly_2 %>% left_join(cluster_df, by = c("id", "date2"))
covid_weekly_3 = covid_weekly_3 %>% left_join(cluster_df, by = c("id", "date2"))
covid_weekly_4 = covid_weekly_4 %>% left_join(cluster_df, by = c("id", "date2"))
covid_weekly_5 = covid_weekly_5 %>% left_join(cluster_df, by = c("id", "date2"))
